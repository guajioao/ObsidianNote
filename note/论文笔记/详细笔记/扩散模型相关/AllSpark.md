...
* 引入一个**先入先出队列**，Class-wise Semantic Memory（S-Mem），来**存储大量的无标注特征**，如图四底部所示。从而允许在重建过程中访问更广阔的无标注特征
...
![[Pasted image 20240902093224.png]]
...
* 通过**比较每个通道的语义信息**和**整个图像的语义信息**，就可以确定该通道最有可能的语义类别
